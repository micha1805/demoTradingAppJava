...
public class JwtService {
    ...
    private static final Integer VALIDATION_DURATION = 1000*60*24; // 1 day in milliseconds

    public String extractUsername(String token) {
        // Subject is email by is called username by convention
    ...
    public String generateToken(
        ...
        return Jwts
                ...
                // Valid for a day :
                .setExpiration(new Date(System.currentTimeMillis() + VALIDATION_DURATION))
